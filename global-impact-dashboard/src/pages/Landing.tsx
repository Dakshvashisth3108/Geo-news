...
import { Activity, ArrowRight, Globe2, Radio, Sparkles } from 'lucide-react';
      ...
      <main className="mx-auto max-w-screen-2xl px-6 pb-24">
        ...
        <section className="relative pt-20 pb-24 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">
            GeoIntel Trade ingests live geopolitical events, scores them against
            the Global Tension Index, and streams correlated trading signals to
            your desk in seconds.
          </p>
          ...
          <div className="mt-10 flex items-center justify-center gap-3">
            ...
            <Button asChild size="lg" variant="outline">
              <a href="https://github.com/Dakshvashisth3108/Geo-news" target="_blank" rel="noreferrer">
                View Source
              </a>
            </Button>
          </div>
...
const Feature: React.FC<{ icon: React.ReactNode; title: string; body: string }> = ({
  icon, title, body,
}) => (
  <Card className="p-6">
